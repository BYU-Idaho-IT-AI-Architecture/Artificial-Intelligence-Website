...
- Deidentified data (surveys, evals, etc.) with PII removed
...
- Other data that could be used to identify individuals
...
- Passwords
- HIPAA-protected data (e.g., medical records)
