...
2. **Only Use University-Approved AI Tools:** When using AI for work, only use the specific [tools and platforms](/genai/approved-tools) that have been approved by the University. The University has contracts and licenses in place that provide security and privacy to our users. Personally Identifiable Information (PII) should not be used with any AI tools [without approval](https://td.byui.edu/TDClient/79/ITHelpCenter/Requests/TicketRequests/NewForm?ID=905&RequestorType=Service). If in doubt, ask your supervisor or your IT Portfolio Manager before using an AI service for university work.
...
[Submit a Formal Request](https://td.byui.edu/TDClient/79/ITHelpCenter/Requests/TicketRequests/NewForm?ID=905&RequestorType=Service)

## Data Classification for AI Use

Understanding how to classify data is essential for responsible AI use.
